...
set_property PACKAGE_PIN W5 [get_ports CLK100MHZ]							
	et_property IOSTANDARD LVCMOS33 [get_ports CLK100MHZ]
	create_clock -add -clk sys_clk_pin -period 10.00 -waveform {0 5} [get_ports CLK100MHZ]
...
#7 segment display
set_property PACKAGE_PIN W7 [get_ports {seg}]					
