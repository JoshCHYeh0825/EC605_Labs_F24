...
# LEDs
#set_property PACKAGE_PIN U16 [get_ports {state_init}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {state_init}]
#set_property PACKAGE_PIN E19 [get_ports {state_101_1}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {state_101_1}]
#set_property PACKAGE_PIN U19 [get_ports {state_101_2}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {state_101_2}]
#set_property PACKAGE_PIN V19 [get_ports {state_101_3}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {state_101_3}]
#set_property PACKAGE_PIN W18 [get_ports {state_pause}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {state_pause}]
#set_property PACKAGE_PIN U15 [get_ports {state_pause}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {state_pause}]
...
# Additional 7 segment displays (seg1, seg2, seg3)
set_property PACKAGE_PIN W6 [get_ports {seg1[0]}]  # Segment 'a' of seg1
set_property IOSTANDARD LVCMOS33 [get_ports {seg1[0]}]
set_property PACKAGE_PIN U8 [get_ports {seg2[0]}]  # Segment 'a' of seg2
set_property IOSTANDARD LVCMOS33 [get_ports {seg2[0]}]
set_property PACKAGE_PIN V8 [get_ports {seg3[0]}]  # Segment 'a' of seg3
